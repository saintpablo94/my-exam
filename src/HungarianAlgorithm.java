...
public class HungarianAlgorithm {
	...
	public static double JCEAssignment(double[][] array) {
		double MinSum = hgAlgorithm(array, "min"); // Call Hungarian algorithm,
													// with minimum cost
		// double MinSum = hgAlgorithm(array, "max"); //Call Hungarian
		// algorithm, with minimum cost
		return MinSum;
	}
	...
	public static void main(String[] args) {
		...
		//
		// //Hard-coded example.
		double[][] array = { { 1, 2, 3 }, { 2, 4, 6 }, { 3, 6, 9 } };
		//
		...
		//
		// System.out.println("The winning assignment (" + sumType + " sum)
		// is:\n");
		 double sum = 0;
		 for (int i=0; i<assignment.length; i++)
		 {
